...
/**
    ...
    public MCParticle newgetTrackMCP(EventHeader event, Track track, String trackType, Boolean hitRequirement){
        ...
        if(hitRequirement == true){
            ...
            else if(trackType.contains("KalmanFullTracks")){
                if(maxValue > 9)
                    return particle;
                else
                    return null;
